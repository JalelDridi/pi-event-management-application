...
public class EmailServiceImpl implements EmailService {
    ...
    public void sendUpcomingEvents() {
        ...
        WebClient webClient = WebClient.builder().baseUrl("http://apigateway:8060/api/v1/auth/authenticate").build();
        ...
        ResponseEntity<Map> responseEntity = restTemplate.postForEntity(
                "http://apigateway:8060/api/v1/auth/authenticate",
                requestEntity,
                Map.class);
...
//        headers.setBearerAuth(bearerToken);
        ...
        try {
            ...
            List<NotificationEventDto> eventsList = restTemplate.getForObject(
                    "http://apigateway:8060/Event/upcoming",
