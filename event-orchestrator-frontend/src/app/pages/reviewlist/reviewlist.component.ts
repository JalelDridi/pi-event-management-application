...
// import { ToastrService } from 'ngx-toastr'; // Removed import
...
export class ReviewlistComponent implements OnInit {
 ...
 constructor(
    ...
    // private toastr: ToastrService, // Commented out injection
 ...
 /* showBadWordsAlert() {
    // this.toastr.error('Review contains bad words. Please remove them.', 'Warning', {
      ...
      if (result.isConfirmed) {
        this.reviewService.deleteReview(reviewId).subscribe(
          ...
          error => {
            ...
            // this.toastr.error('Error deleting review. Please try again later.', 'Error', {
            //   positionClass: 'toast-bottom-center',
            //   timeOut: 3000
            // });
          }
    ...
    if (this._updatedReview) {
      ...
      this.reviewService.updateReview(reviewId, this._updatedReview).subscribe(
        ...
        error => {
          ...
          // this.toastr.error('Error updating review. Please try again later.', 'Error', {
          //   positionClass: 'toast-bottom-center',
          //   timeOut: 3000
          // });
        }
